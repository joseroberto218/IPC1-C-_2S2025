...
public class Practica1_202200030 {
    ...
    //Clase para cuando se realice la pelea
    static class fght {
        int fght1, fght2;
    ...
    //listas principales para un mejor manejo de la memoria de los datos
    static ArrayList<avatar> Peleadores = new ArrayList<>();
    static ArrayList<fght> Peleas = new ArrayList<>();
    
    //ID que se va incrementando automaticamente
    static int nxtid = 1;
    static Scanner scanner = new Scanner(System.in);
     ...
     public static void main(String[] args){
         ...
         //MENÚ CON SWITCH (en bucle hasta que se decide salir)
         do {
            ...
            opcion = sinleer("Elige una opcion:");
              //opcion = scanner.nextInt(); <- funcion que ya no me sirvio
              
              //el switch con las funciones ya creadas y vinculadas
         switch (opcion){
             case 1 -> agregarp();
            case 2 -> modificarp();
            case 3 -> eliminarp();
   ...
   //función para leer un número entero con el rango pedido  
   ...
   //función leer un número entero que excede el límite y regresar 
   ...
   //función para cuando no sé escribe nada
   ...
   //FUNCIÓN QUE PERMITE AGREGAR UN NUEVO PERSONAJE
  ...
  static void modificarp(){
      ...
      //Mini busqueda dependiendo del ID o nombre
      if (b == 1){
          int id = sinleer("ID: ");
          p = buscarid(id);
      } else {
      ...
      mostrarp(p); //Función que muestra los datos
   ...
   //FUNCIÓN ELIMINAR PERSONAJE POR ID
  ...
  //FUNCIÓN VER PERSONAJE POR MEDIO DE ID
  static void verp(){
  ...
  //FUNCIÓN QUE VER LA LISTA DE LOS PERSONAJES 
  ...
  static void progfght(){
      ...
      //Guardamos la pelea junto con la fecha actual
  ...
  //FUNCIÓN QUE MUESTRA EL HISTORIAL DE PELEA
